...
/* USER CODE BEGIN 0 */
DMA_BUFFER uint8_t dcmi_image_buffer_8bit_1[FULL_IMAGE_SIZE] = {1};
/**
...
void MX_DCMI_Init(void)
{
  ...
  DCMI->IER=0x0;
      ...
      __HAL_DCMI_ENABLE_IT(&hdcmi,DCMI_IT_VSYNC);      //使能帧中断
...
void HAL_DCMI_MspInit(DCMI_HandleTypeDef* dcmiHandle)
{
  ...
  /* USER CODE END DCMI_MspInit 0 */
   ...
   //  hdma_dcmi.Init.MemBurst=DMA_MBURST_INC4;                //存储器突发传输
